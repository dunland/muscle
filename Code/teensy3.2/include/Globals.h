...
enum EffectsType
{
    ...
    Change_CC = 9,
    Random_CC_Effect = 10,
    MainNoteIteration = 11,   // increase note_idx of Score
    Reflex_and_PlayMidi = 12, // combines PlayMidi and ChangeCC
    TapTempoRange
};
...
enum CC_Type
{
    ...
    KP3_Level_Slider = 93,
    KP3_FX_Depth = 94,
    KP3_Hold = 95,     // send 0 or 1 to de-/activate
    KP3_Sample_A = 33, // sendNote on/off !
    KP3_Sample_B = 34,
    KP3_Sample_C = 35,
    KP3_Sample_D = 36,
    ...
    // whammy CC Channels:
    whammyPedal = 11,
    whammy_CHORDS_2OCT_UP_ON = 42,
    whammy_CHORDS_2OCT_UP_OFF = 63,
    whammy_CHORDS_OCT_UP_ON = 43,
    whammy_CHORDS_OCT_UP_OFF = 64,
    whammy_CHORDS_5TH_UP_ON = 44,
    whammy_CHORDS_5TH_UP_OFF = 65,
    whammy_CHORDS_4TH_UP_ON = 45,
    whammy_CHORDS_4TH_UP_OFF = 66,
    whammy_CHORDS_2ND_UP_ON = 46,
    whammy_CHORDS_2ND_UP_OFF = 67,
    whammy_CHORDS_2ND_DOWN_ON = 47,
    whammy_CHORDS_2ND_DOWN_OFF = 68,
    whammy_CHORDS_4TH_DOWN_ON = 48,
    whammy_CHORDS_4TH_DOWN_OFF = 69,
    whammy_CHORDS_5TH_DOWN_ON = 49,
    whammy_CHORDS_5TH_DOWN_OFF = 70,
    whammy_CHORDS_OCT_DOWN_ON = 50,
    whammy_CHORDS_OCT_DOWN_OFF = 71,
    whammy_CHORDS_DIVEBOMB_ON = 51,
    whammy_CHORDS_DIVEBOMB_OFF = 72,
    whammy_CHORDS_OCT_2OCT_ON = 62,
    whammy_CHORDS_OCT_2OCT_OFF = 83,
    whammy_CHORDS_OCT_10TH_ON = 61,
    whammy_CHORDS_OCT_10TH_OFF = 82,
    whammy_CHORDS_OCT_OCT_ON = 60,
    whammy_CHORDS_OCT_OCT_OFF = 81,
    whammy_CHORDS_OCT_4TH_ON = 59,
    whammy_CHORDS_OCT_4TH_OFF = 80,
    whammy_CHORDS_5TH_OCT_ON = 58,
    whammy_CHORDS_5TH_OCT_OFF = 79,
    whammy_CHORDS_5TH_6TH_ON = 57,
    whammy_CHORDS_5TH_6TH_OFF = 78,
    whammy_CHORDS_5TH_5TH_ON = 56,
    whammy_CHORDS_5TH_5TH_OFF = 77,
    whammy_CHORDS_4TH_5TH_ON = 55,
    whammy_CHORDS_4TH_5TH_OFF = 76,
    whammy_CHORDS_4TH_3RD_ON = 54,
    whammy_CHORDS_4TH_3RD_OFF = 75,
