...
#define HIHAT_FIRST_STROKE true

#define KICK_THRESHOLD 40
#define KICK_CROSSINGS 5
#define KICK_DELAY_AFTER_STROKE 20
#define KICK_FIRST_STROKE true

#define TOM1_THRESHOLD 10
#define TOM1_CROSSINGS 2
#define TOM1_DELAY_AFTER_STROKE 5
#define TOM1_FIRST_STROKE true

#define TOM2_THRESHOLD 70
#define TOM2_CROSSINGS 4
#define TOM2_DELAY_AFTER_STROKE 5
#define TOM2_FIRST_STROKE true

#define STANDTOM_THRESHOLD 80
#define STANDTOM_CROSSINGS 4
#define STANDTOM_DELAY_AFTER_STROKE 7
#define STANDTOM_FIRST_STROKE true
...
#define COWBELL_FIRST_STROKE true
